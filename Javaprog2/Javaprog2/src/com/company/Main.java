...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        int task;
        boolean a = true;
        String mytext = "Князь равнодушно 42,2 замолк. Анна Павловна 423. C свойственною ей придворною 43 . и женскою ловкостью 43 и быстротою такта. захотела и .щелкануть 11 князя за то., что он дерзнул 32 так отозваться о лице,  . рекомендованном 33 императрице. и в то же время 10 утешить его.\n" +
